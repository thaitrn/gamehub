...
const expected = [
  ...
  { id: 'game3', status: 'Live', cta: 'Chơi ngay', href: 'https://game3-sandy-eta.vercel.app' },
...
if (await page.locator('text=Máy Bay Mừng 2/9').count()) throw new Error('Removed product must not be visible.');
