...
export const games: readonly Game[] = [
  {
    ...
    playUrl: 'https://thais-mac-mini.tail6e29ae.ts.net/pixel-quest/',
    ctaLabel: 'Chơi ngay',
    published: true,
    sortOrder: 1,
    owner: 'thaitrn',
  ...
  },
  {
    ...
    playUrl: 'https://thais-mac-mini.tail6e29ae.ts.net/game3/',
    ctaLabel: 'Chơi ngay',
    published: true,
    sortOrder: 2,
    owner: 'Product owner',
  ...
  },
  {
    ...
    playUrl: 'https://thais-mac-mini.tail6e29ae.ts.net/babylon-pilot/',
